	...
	return (
		<div className="flex-1 flex flex-col min-h-screen px-5 py-5 font-geist-sans">
			...
			<Image
				...
				className="w-full h-1/2 object-cover rounded-md border border-primary-dark dark:border-primary-light mt-5 lg:hidden"
			/>

			<div className="w-full flex-1 flex flex-col items-center">
				<div className="w-full flex flex-col flex-1 md:max-w-[500px] lg:justify-center md:justify-start justify-center">
					<p className="text-3xl text-primary-dark dark:text-primary-light font-medium md:text-justify text-center lg:mt-0 md:mt-10 mt-2">
